layui.use(['form','layer','laydate','table','laytpl'],function(){
    ...
    var tableIns = table.render({
        elem: '#scoreList',
        url : path+'/page/score/allScoreList',
        cellMinWidth : 95,
        page : true,
        height : "full-125",
        limit : 10,
    ...
    table.render({
            elem: '#clazzList',
            url : path+'/page/score/clazzScoreList',
            cellMinWidth : 95,
            page : true,
            height : "full-125",
            limit : 10,
 ...
 // 基于准备好的dom，初始化echarts实例
    setTimeout(function(){
        ...
        $.get(path+'/page/score/courseScoreList').done(function (data) {
        	var data = data.data;
        ...
        $.get(path+'/page/score/clazzScoreList').done(function (data) {
        	var	clazzNames = "";
        		clazzNames += "[";
        	var	datas = "";
        		datas += "[";

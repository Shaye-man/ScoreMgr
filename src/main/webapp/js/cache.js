...
layui.use(['form','jquery',"layer"],function() {
    ...
    //公告层
    function showNotice(){
        var content = '<div style="padding:20px 30px; text-align:justify; line-height: 24px; background-color: #393D49; color:#fff; text-indent:2em;border-bottom:1px solid #e2e2e2;">'+
                  '<p class="layui-blue">这个板块是用来发布一些重要公告的,管理员可以将重要的公告发布通知到每一位用户</p>'+
                  '<p>由于时间跟精力问题，目前的成绩管理系统V1.0 还处于Beta版本，里面的基础功能都已经实现了，集成了Echart、layer等插件。未来在时间允许的情况下，将会继续完善这个项目。同学们如果需要查看源码的话，可以在主页面下点击Github下载源码！</p></div>';
